...
export default function IodOdo24ServiceSection() {
  const hasHeading = Boolean(iodOdo24Service.title);
  ...
  const hasCtaLabel = Boolean(iodOdo24Service.cta.ctaLabel && iodOdo24Service.cta.ctaUrl);
    ...
    <section className="py-14">
      <div className="max-w-[1060px] mx-auto px-5">
        <div className="bg-gray-200 rounded-2xl py-7 px-16 max-sm:px-5">
          {hasHeading && <h2 className="text-gray-600 text-3xl font-bold">{iodOdo24Service.title}</h2>}
